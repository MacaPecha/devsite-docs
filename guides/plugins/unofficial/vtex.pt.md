...
2. Cadastre uma afiliação de gateway de pagamento com o "Mercado Libre".
3. Configure as condições de pagamento Mercado Libre.
4. Configure device fingerprint.

## Cadastre uma afiliações de gateway

Uma afiliação de gateway é um conjunto de configurações que representam o processamento de seus pagamentos com o Mercado Libre.
...
Para criar uma **afiliação de gateway de pagamento com o Mercado Libre**, siga os passos abaixo:
...
| PublicKey | Refere-se às suas [credenciais]([FAKER][CREDENTIALS][URL]) do Mercado Libre. Complete com sua Public Key. |
| AccessToken | Refere-se às suas [credenciais]([FAKER][CREDENTIALS][URL]) do Mercado Libre. Complete com seu Access Token. |
...
| External Installments | Sim. Utilização das condições de parcelamento diretamente de sua conta Mercado Libre. |
...
| MaxInstallments | Escolha a quantidade máxima de parcelas enviadas ao Mercado Libre. |
...
E pronto! Sua afiliação com o Mercado Libre já está ativa!
...
| Campos | Dados necessários |
| --- | --- |
| Application Key | Refere-se às suas [credenciais]([FAKER][CREDENTIALS][URL]) do Mercado Libre. Complete com sua Public Key. |
| Application Token | Refere-se às suas [credenciais]([FAKER][CREDENTIALS][URL]) do Mercado Libre. Complete com seu Access Token. |
...
Após ter criado sua afiliação com o Mercado Libre, você tem a opção de oferecer em sua loja pagamentos com [cartão de crédito](#bookmark_condição_de_pagamento_cartão_de_crédito), [boleto bancário](#bookmark_condição_de_pagamento_boleto_bancário), pagamentos via [Checkout Pro](#bookmark_condição_de_pagamento_checkout_pro) e também [Pix](#bookmark_condição_de_pagamento_pix).
...
Para criar uma **condição de pagamento cartão de crédito** utilizando sua afiliação com o Mercado Libre, siga os passos abaixo:
...
6. Em opções de parcelamento, escolha parcelamento "Automático", onde utiliza as condições de **parcelamento diretamente de sua conta Mercado Libre**.
7. Clique em "Salvar".
<p>&nbsp;</p>
...
Para criar uma **condição de pagamento boleto bancário utilizando sua afiliação com o Mercado Libre**, siga os passos abaixo:
...
O [Checkout Pro](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/online-payments/checkout-pro/introduction) é a integração que te permite cobrar através do Mercado Libre, contando com as meios de pagamentos como Pix, boleto parcelado, débito virtual da Caixa e carteira digital do Mercado Libre.

#### Configuração do meio de pagamento Mercado Libre
...
1. No painel de administração de sua loja, acesse "Configurações" do módulo de pagamentos.
2. Na aba "Condições de pagamento", clique no botão "+".
3. Na seção "Outro", selecione a condição de pagamento "Mercado Libre".
4. Informe o "Nome da regra" para facilitar a identificação e ative a condição de pagamento no campo "Status".
5. Informe sua afiliação com o MercadoPagoV1, no campo "Processar com a afiliação".
6. Clique em "Salvar".
<p>&nbsp;</p>
...
#### Configuração do meio de pagamento Mercado Libre PRO

**O comprador finalizará o pagamento no Mercado Libre via formulário web modal** diretamente em sua loja.
...
#### Configuração do meio de pagamento Mercado Libre Wallet

**O comprador finaliza o pagamento com a carteira do Mercado Libre exclusivamente de usuários cadastrados** e uma vez concluído o processo, voltará para sua loja.
...
> Importante
>
> Caso as condições de pagamento MercadoPagoPro e MercadoPagoWallet não estiverem disponíveis para adicioná-las, certifique em sua loja de aplicativos da VTEX que o App Mercado Libre Payment APP esteja instalado ou solicite a instalação pela equipe VTEX sob demanda através de ticket no [Support VTEX](https://support.vtex.com). <br>
...
| --- | --- | --- |
| ID | 10302316 | Número da transação de Mercado Libre. |
...
| External_reference | 503451 | Identificador da VTEX enviado a Mercado Libre. |
...
| --- | --- |
| `unauthorized_use_of_live_credentials` | Isso significa que as credenciais da conta do Mercado Libre não estão ativadas. Você deve ir para a página de credenciais e ativá-las |
