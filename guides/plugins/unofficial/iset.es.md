...
iSET es una **plataforma virtual que te permite recibir pagos con Mercado Libre**.
Puedes ofrecer a tus clientes la posibilidad de pagar con tarjeta de crédito o boleto y [vender directo en tu sitio](#bookmark_checkout_transparente), [cobrar por el sitio de Mercado Libre](#bookmark_checkout_pro) o por [ambos checkouts](#bookmark_ambos_checkouts).
...
1. Activa a Mercado Libre como medio de pago dentro de tu tienda.
1. Configura las formas de pago.

## Activa Mercado Libre en tu tienda

Para **activar tu cuenta de Mercado Libre en iSET**, sigue estos pasos:

1. Accede a las “Formas de pago” en la sección de Módulos del panel de administración de tu tienda. 
1. Busca en la lista de medios de pago a Mercado Libre e ingresa en “Opciones de configuración”.
...
Luego de activar Mercado Libre, tienes la opción de ofrecer los siguientes formas de pago: [Checkout Pro](#bookmark_checkout_pro), [Checkout Transparente](#bookmark_checkout_transparente) o [ambos checkouts](#bookmark_ambos_checkouts).
...
1. Agrega el [e-mail de tu cuenta de Mercado Libre](https://www.mercadopago[FAKER][URL][DOMAIN]/profile#from-section=menu) en “E-mail de registro en Mercado Libre”.
1. Completa los campos Client ID y Client Secret con las [credenciales]([FAKER][CREDENTIALS][URL]) de tu cuenta de Mercado Libre.
1. Haz clic en “Cerrar” y después en “Guardar cambios”.
<p>&nbsp;</p>
...
1. Completa el [e-mail de tu cuenta de Mercado Libre](https://www.mercadopago[FAKER][URL][DOMAIN]/profile#from-section=menu) en “E-mail de registro en Mercado Libre”.
1. Completa en los campos Client ID, Client Secret y Public Key, las [credenciales]([FAKER][CREDENTIALS][URL]) de tu cuenta de Mercado Libre.
1. Haz clic en “Cerrar” y después en “Guardar cambios”.
<p>&nbsp;</p>
...
Puedes ofrecer a tus clientes la opción de finalizar el pago directamente en tu tienda o ser redirigidos al sitio web de Mercado Libre.
...
1. Agrega el [e-mail de tu cuenta de Mercado Libre](https://www.mercadopago.com.br/profile#from-section=menu) en “E-mail de registro en Mercado Libre”.
1. Completa los campos “Cliend ID, Clien Secret y Public Key” con las [credenciales de tu cuenta de Mercado Libre]([FAKER][CREDENTIALS][URL]).
1. Haz clic en “Cerrar” y después en “Guardar cambios”.
<p>&nbsp;</p>
...
> Importante
>
> Las cuotas deben quedar configuradas como automáticas para evitar problemas al procesar los pagos. Vamos a tomar las cuotas habilitadas en tu cuenta de Mercado Libre según corresponda.

1. Ingresa en “Formas de pago” en la sección de Módulos del panel de administración de tu tienda. 
1. Busca en la lista de medios de pago a Mercado Libre e ingresa en “Opciones de configuración”.
1. Selecciona en “Categoría de productos” la categoría que aplica a tus productos. 
1. Completa los siguientes campos según la configuración de tu cuenta de Mercado Libre:
...
1. Ingresa a la sección [Tu negocio](https://www.mercadopago[FAKER][URL][DOMAIN]/business/) en tu cuenta de Mercado Libre.
...
1. Completa los siguientes campos según la configuración de tu tienda:
    ...
    | Usar campaña de descuento | Informa si tienes disponibles cupones de descuentos desde tu cuenta de Mercado Libre. |
...
> Importante
>
> Por el momento, no es posible utilizar las campañas de descuentos con Mercado Libre. 
