...
| Currency | <br/> Local (based on the country where the Mercado Libre account is registered). <br/> <br/> |
...
| File | <br/>The generated reports are saved in your Mercado Libre account.<br/><br/> |
...
>
> Create reports in a scheduled and manual way through an integration with Mercado Libre.
>
