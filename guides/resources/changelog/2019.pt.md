...
- **Atualizações na documentação:** Guias, referências e tutoriais para te ajudar a monetizar seu negócio integrando Mercado Libre.

## 5 de dezembro de 2019

No Mercado Libre, sempre buscamos otimizar nossa plataforma, oferecendo a mais alta eficiência e segurança no processamento de pagamentos.
...
**Módulos oficiais com suporte do Mercado Libre**

Queremos dar a melhor experiência para você sempre. Por isso, informamos quais módulos contam com suporte oficial do Mercado Libre e que você pode contar com serviço personalizado sempre que precisar:  
...
**Navegadores compatíveis com o Mercado Libre**

Atualizamos nossos protocolos de segurança para atender os mais altos padrões de segurança.

Para continuar usando o Mercado Libre sem problemas, é necessário que você o faça usando as versões suportadas pelos nossos domínios:
...
> Lembre-se de que você não poderá acessar nenhum site do Mercado Libre com os navegadores incompatíveis.
