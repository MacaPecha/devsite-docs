...
1. Inicie a sessão no Mercado Libre com a conta do **marketplace** e gere um APP_ID com todas as suas configurações e a URL a ser enviada ao **vendedor** para que vincule sua conta.
2. Inicie a sessão no Mercado Libre com o **vendedor** e vincule a conta ao marketplace, entrando na URL configurada.
