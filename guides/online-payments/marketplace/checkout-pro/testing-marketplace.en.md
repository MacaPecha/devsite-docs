...
1. Log in to Mercado Libre with the marketplace account and generate an APP_ID with all your settings and the URL to send to the seller to connect the seller’s account.
2. Log in to Mercado Libre with the seller and connect the account to the marketplace, entering the configured URL.
