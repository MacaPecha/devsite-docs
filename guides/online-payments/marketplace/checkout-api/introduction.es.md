...
Mercado Libre te permite realizar cobros a nombre de los vendedores de tu plataforma y opcionalmente cobrar una comisión por la transacción.
...
> Nota
>
> La comisión de Mercado Libre será descontada de los fondos que reciba el vendedor.
> Primero se descuenta la comisión de Mercado Libre, y sobre el restante se descuenta la comisión del Marketplace. 
...
Inicialmente tu aplicación sólo podrá interactuar con Mercado Libre en **Modo Sandbox**, una réplica exacta de **Modo Producción**, diseñado con el objetivo de facilitar las pruebas durante la integración.
