...
Mercado Libre allows you to collect payments on behalf of the sellers of your platform and optionally charge a commission for the transaction.
...
_Clarification: The payment split can only be done between two Mercado Libre accounts (Marketplace and the seller associated to it), no more._

> NOTE
>
> Note
>
> Mercado Libre’s fee will be deducted from the funds received by the seller.
> First the Mercado Libre fee is discounted, and after that the Marketplace fee. 
...
Initially, your application will only be able to interact with Mercado Libre in **Sandbox Mode**, an exact replica of the **Production Mode**, designed with the purpose of facilitating tests during the integration.
