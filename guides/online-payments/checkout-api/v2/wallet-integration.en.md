...
To start, you need to generate your payment preference from your backend with the [Mercado Libre SDK](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/en/guides/online-payments/checkout-api/v2/previous-requirements#bookmark_always_use_our_libraries) you used in your Checkout API. 
