...
**Use nossa biblioteca oficial para acessar a API de Mercado Libre** no seu frontend e coletar os dados de forma segura.
...
Tenha em conta que para que esse passo funcione é necessário que configure sua [chave privada]([FAKER][CREDENTIALS][URL]) e que para interagir com nossas APIs recomendamos utilizar o [SDK oficial do Mercado Libre](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/online-payments/checkout-api/previous-requirements/#bookmark__instale_o_sdk_do_mercado_pago).
