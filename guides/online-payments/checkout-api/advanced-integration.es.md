...
Para que un cliente pueda hacer un pago con sus datos guardados, es necesario volver a capturar el código de seguridad. Mercado Libre no puede almacenar esa información por cuestiones de seguridad.
