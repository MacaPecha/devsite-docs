...
A partir do aplicativo do Mercado Libre, você tem a opção de cobrar nas suas lojas físicas através do dispositivo Point.
Você não precisa saber sobre programação.

Vamos te guiar para que você possa cobrar:

- Acesse o aplicativo do Mercado Libre, na seção de cobrança com Point e conecte seu dispositivo Point.
...
Você pode verificar suas vendas na lista de atividades da conta do Mercado Libre ou integrar [notificações](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/pt/guides/notifications/webhooks) no seu sistema de gestão.
