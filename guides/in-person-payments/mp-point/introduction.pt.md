...
Você pode aumentar suas vendas no mundo físico cobrando com o dispositivo Mercado Libre Point.

O Aplicativo móvel do Mercado Libre junto com o Point permite cobrar de maneira segura cartões de crédito e cartões de débito. Suas principais funcionalidades são:
...
Seus vendedores usando o aplicativo móvel do Mercado Libre passam o cartão do cliente no Point efetuando a cobrança. Assim, você pode oferecer em suas lojas físicas parcelamento sem juros e todos os benefícios oferecidos pelo Mercado Libre.

Para poder cobrar, é necessário que adquira o dispositivo Mercado Libre Point:
...
Existem distintas alternativas para que possa cobrar através do Mercado Libre Point:
